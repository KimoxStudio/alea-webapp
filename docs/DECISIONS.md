...
- Forward-looking items (3 Vercel deployment blockers, P0 secret rotation, `lib/server` reorganization) were tracked as Linear KIM-393..422 (Supabase→Neon migration); `docs/MIGRATION-supabase-to-neon.md` was removed 2026-07-17 once Linear became the source of truth (same precedent as PR #166).
